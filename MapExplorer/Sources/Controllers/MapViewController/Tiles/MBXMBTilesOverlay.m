...
- (NSData *)mbtiles:(NSString *)mbtilesPath dataForSingleColumnQuery:(NSString *)query
{
    ...
    // tile loading threads. Because the database connection is unique rather than shared, and because
    ...
    if (rc == SQLITE_ROW) {
        ...
        // The query returned no results. This is a normal, frequent, and harmless outcome for maps which do not cover the whole world.
