...
class TimelineYearLayout: NSCollectionViewFlowLayout {
    ...
    override var collectionViewContentSize: NSSize {
        ...
        let width = CGFloat(totalYears * style.yearLayoutWidth)
    ...
    override func layoutAttributesForElements(in rect: NSRect) -> [NSCollectionViewLayoutAttributes] {
        ...
        let minYear = source.firstYear + Int(rect.minX) / style.yearLayoutWidth
        let maxYear = source.firstYear + Int(rect.maxX) / style.yearLayoutWidth
    ...
    private func attributes(for event: TimelineEvent, in source: TimelineDataSource) -> NSCollectionViewLayoutAttributes? {
        ...
        let x = CGFloat((event.start - source.firstYear) * style.yearLayoutWidth)
    ...
    private func attributes(year: Int, in source: TimelineDataSource) -> NSCollectionViewLayoutAttributes? {
        ...
        let x = CGFloat(item * style.yearLayoutWidth)
        let size = CGSize(width: CGFloat(style.yearLayoutWidth), height: Constants.headerHeight)
